...
export function hasPermission(userRole: string, permission: string): boolean {
    ...
    const permissions: Record<string, string[]> = {
        ...
        OWNER: ['CREATE_STORE', 'MANAGE_STORE_USERS', 'VIEW_COMPANY_ANALYTICS', 'CREATE_CARDS'],
        GENERAL_ADMIN: ['CREATE_STORE', 'MANAGE_STORE_USERS', 'VIEW_COMPANY_ANALYTICS', 'CREATE_CARDS'],
